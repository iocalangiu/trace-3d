function B = preprocess3D_medfilt3(A,siz,padopt,CHUNKFACTOR)
%preprocess3D_medfilt3
%Description: this function removes the salt and pepper noise from a 3-D
%data set.
%--------------------------------------------------------------------------
...
disp('Removing salt and pepper noise')
disp('-----------------------------------------------------------')
if nargin~=4
    CHUNKFACTOR = 1;
end
